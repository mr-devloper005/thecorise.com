...
const inputClass = 'h-12 rounded-2xl border border-[var(--editable-border)] bg-white/95 px-4 text-base font-bold text-[#101426] outline-none transition placeholder:text-[#667085] focus:border-[var(--slot4-accent-fill)] focus:bg-white'
